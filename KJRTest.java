...
public class KJRTest extends TestCase implements Directions
{
    ...
    public final void assertFrontIsClear(final UrRobot robot) {
        assertTrue("Front is blocked.", this.frontIsClear(robot));
    }
    
    public final void assertFrontIsBlocked(final UrRobot robot) {
        assertTrue("Front is clear.", !this.frontIsClear(robot));
    }
